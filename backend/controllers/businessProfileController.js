...
export async function createBusinessProfile(req, res) {
    ...
    return res.status(201).json({
        ...
        console.log("CreateBudiness profile error:", error)
...
export async function updateBusinessProfile(req, res) {
    try{
        ...
        if(!existing){
            return res.status(404).json({
                success : false,
                message : "Business profile not foud."
            })
        }
    ...
    return res.status(200).json({
        ...
        console.log("UpdateBudiness profile error:", error)
        return res.status(500).json({
            success : false,
            message : "Server error"
        })
...
export async function getMyBusinessProfile(req, res) {
    try{
        ...
        console.log("GetBudiness profile error:", error)
        return res.status(500).json({
            success : false,
            message : "Server error"
        })
